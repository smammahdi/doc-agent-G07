...
| `Qwen/Qwen3-Embedding-0.6B-GGUF` | `qwen3-embedding-0-6b-gguf` | Quantized GGUF | 1024 | ~450 MB | 0.6B Qwen3 GGUF (Q4_K_M/Q8_0) for llama.cpp/Ollama |
| `Qwen/Qwen3-Embedding-4B` | `qwen3-embedding-4b` | Text Embed | 2560 | ~8.2 GB | High-capacity 4.0B param Qwen3 dense text embedder |
| `Qwen/Qwen3-Embedding-4B-GGUF` | `qwen3-embedding-4b-gguf` | Quantized GGUF | 2560 | ~2.5 GB | 4.0B Qwen3 GGUF (Q4_K_M/Q8_0) for memory-constrained setups |
