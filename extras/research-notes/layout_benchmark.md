...
All metrics were computed automatically by the benchmark harness ([`extras/layout-benchmarks/engines/layout_research/figextract/compare.py`](../layout-benchmarks/engines/layout_research/figextract/compare.py)) without manual annotation:
